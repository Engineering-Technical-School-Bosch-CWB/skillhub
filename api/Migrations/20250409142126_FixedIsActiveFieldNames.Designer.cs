...
namespace api.Migrations
{
    ...
    [Migration("20250409142126_FixedIsActiveFieldNames")]
    partial class FixedIsActiveFieldNames
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Domain.Models.ClassEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("classEvent", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Domain.Models.EventMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api.Domain.Models.EventType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api.Domain.Models.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Api.Domain.Models.User", b =>
                {
                    ...
                    b.Property<int?>("profile_picture_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api.Domain.Models.ClassEvent", b =>
                {
                    ...
                    b.HasOne("Api.Domain.Models.Event", "Event")
                        .WithMany("ClassEvents")
            ...
            modelBuilder.Entity("Api.Domain.Models.Event", b =>
                {
                    b.HasOne("Api.Domain.Models.EventType", "EventType")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Api.Domain.Models.EventMember", b =>
                {
                    ...
                    b.HasOne("Api.Domain.Models.User", "Member")
                        .WithMany("EventMembers")
            ...
            modelBuilder.Entity("Api.Domain.Models.User", b =>
                {
                    ...
                    b.HasOne("Api.Domain.Models.Image", "ProfilePicture")
                        .WithMany()
